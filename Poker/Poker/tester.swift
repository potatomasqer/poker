...
class tester: UIViewController {
    ...
    @IBAction func startGame(_ sender: Any) {
        ...
        nessaryValues = AIController.cardRemover(card1: AICard1, card2: AICard2, card3: AICard3, card4: AICard4, card5: AICard5, handValue: AllCardValue, visibleCards: [], nessaryValues: nessaryValues)
